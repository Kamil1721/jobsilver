...
## Summary
- 2139 nodes · 4362 edges · 127 communities (115 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29e35e18`
...
Cohesion: 0.10
Nodes (17): ChatProviderProps, VALID_PAGE_PATHNAMES, ValidPathname, ApplicationQuestion, AttachFilePayload, CHAT_EVENTS, ChatEventType, dispatchAttachFile() (+9 more)

### Community 2 - "Job Card UI & Utils"
Cohesion: 0.07
Nodes (37): ChatHeader(), ChatPanel(), ChatPanelProps, getPageContext(), PAGE_CONTEXT_HINTS, MessageInput(), QuickAction, QuickActions() (+29 more)
...
Cohesion: 0.13
Nodes (23): ChatButton(), ChatProvider(), Action, ActionType, actionTypes, addMessage(), ChatState, clearMessages() (+15 more)
...
Cohesion: 0.06
Nodes (43): MessageInputProps, AdminPage(), COUNTRY_PHONE_CODES, CVGeneratorDialog(), CVGeneratorDialogProps, EducationEntry, getPhoneCodeFromCountry(), WorkHistoryEntry (+35 more)
...
Cohesion: 0.10
Nodes (23): ChatHeaderProps, ThemeProvider(), ThemeProviderProps, ThemeToggle(), Theme, ThemeContext, ThemeContextValue, useTheme() (+15 more)

### Community 12 - "Account & Subscription Pages"
Cohesion: 0.09
Nodes (26): AnswerValue, CvUploadState, INITIAL_CV, NormalizedQuestion, QuestionsResponse, QuestionType, StatusResponse, TERMINAL_STATUSES (+18 more)
...
Cohesion: 0.16
Nodes (18): checkoutRequestSchema, getBaseUrl(), POST(), DowngradeReason, getStripeErrorMessage(), POST(), VALID_REASONS, isDowngrade() (+10 more)

### Community 16 - "Interaction Tracking"
Cohesion: 0.12
Nodes (15): parseCV(), sanitizeCVText(), GET(), POST(), VALID_REPORT_TYPES, openai, POST(), sanitizeInput() (+7 more)

### Community 17 - "Supabase Server Client"
Cohesion: 0.13
Nodes (17): buildSearchQueries(), curateJobsForUser(), CurationResult, fetchPersonalizedJobs(), getInternalCallUserId(), POST(), GET(), Feature (+9 more)
...
Cohesion: 0.13
Nodes (16): SearchBar(), SearchBarProps, SearchFilters, countries, Country, formatPhoneNumber(), parsePhoneNumber(), PhoneInput() (+8 more)
...
Cohesion: 0.10
Nodes (20): AIUsage, UsageDetails(), UsageIndicator(), UsageIndicatorProps, getScoreTheme(), PreferenceMatch(), PreferenceMatchProps, sizeConfig (+12 more)

### Community 29 - "Search Route & Query Prep"
Cohesion: 0.14
Nodes (21): getUserLearnedPreferences(), injectDiversity(), mergeExplicitWithLearnedPreferences(), GeneratedQueries, QueryGenerationInput, getCompanySizeCategory(), mapIndustriesToTaxonomyFilter(), mapWorkArrangementsToFilter() (+13 more)
...
Cohesion: 0.08
Nodes (35): UpgradeModalEventDetail, ReportStats, Tester, TesterInvite, TesterInviteStatus, TesterStats, User, UserReport (+27 more)
...
Cohesion: 0.07
Nodes (60): AdminAuthResult, checkAdminAuth(), getAdminEmails(), getRedactedAdminEmails(), isAdminEmail(), announcementTypeSchema, createAnnouncementSchema, DELETE() (+52 more)
...
Cohesion: 0.13
Nodes (17): JobAIChat(), JobAIChatProps, Message, JobCardProps, JobCardSkeleton(), ColumnStatus, containerVariants, itemVariants (+9 more)
...
Cohesion: 0.09
Nodes (19): INDUSTRY_CATEGORIES, JOB_TITLES_BY_INDUSTRY, DEFAULT_JOB_FILTERS, DEFAULT_SCREENING_ANSWERS, SetupWizard(), STEPS, WizardData, StepCV() (+11 more)
...
Cohesion: 0.16
Nodes (21): AIFeature, canUseAI(), CanUseAIResult, CanUseFeatureResult, checkCanUseFeature(), checkNearLimits(), DailyUsageStats, featureToResource() (+13 more)
...
## Knowledge Gaps
- **801 isolated node(s):** `DbQuestionRow`, `AshbyFieldEntry`, `AshbyFormSection`, `AshbyApplicationForm`, `AshbyJobPosting` (+796 more)
...
- **Why does `cn()` connect `Job Card UI & Utils` to `Dashboard Page & UI Primitives`, `Community 4`, `NPM Dependencies`, `Preference Scoring`, `Setup Wizard Form Steps`, `Community 104`, `Landing Page UI`, `Subscription Context & Feature Gate`, `Account & Subscription Pages`, `Community 107`, `Public Pages & Footer`, `Community 110`, `Pricing & Plan Selection`, `Community 113`, `Community 117`, `Chat Panel Components`, `Setup Wizard & Filter Validation`, `Dialog Components`?**
