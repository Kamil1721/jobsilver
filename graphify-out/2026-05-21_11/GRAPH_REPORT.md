...
## Corpus Check
- 343 files · ~293,649 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2158 nodes · 4402 edges · 131 communities (118 shown, 13 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b49d2093`
...
Cohesion: 0.06
Nodes (38): SKILL_PRESETS, SkillsSection(), SkillsSectionProps, EMPTY_ENTRY, WorkHistoryEntry, WorkHistorySectionProps, DEFAULT_JOB_FILTERS, DEFAULT_SCREENING_ANSWERS (+30 more)
...
Cohesion: 0.16
Nodes (18): ApplicationQuestion, Action, ActionType, actionTypes, addMessage(), clearMessages(), closeChat(), dispatch() (+10 more)
...
Cohesion: 0.09
Nodes (38): authenticateCronRequest(), curateJobsForUser(), CurationSummary, fetchAndCurateJobs(), fetchJobsFromSearch(), GET(), POST(), safeCompare() (+30 more)

### Community 7 - "Rate Limiting & Feature Access"
Cohesion: 0.13
Nodes (39): ANNOUNCEMENTS_RATE_LIMIT, GET(), VALID_PLANS, GET(), GET(), POST(), DELETE(), favoriteSchema (+31 more)
...
Cohesion: 0.21
Nodes (8): UpgradeModal(), DashboardLayout(), SystemMessage, clearChatState(), clearToastState(), Avatar, AvatarFallback, AvatarImage
...
Cohesion: 0.52
Nodes (6): extractTextFromDOCX(), extractTextFromFile(), extractTextFromPDF(), extractTextFromPDFAdobe(), extractTextFromPDFBasic(), openai
...
Cohesion: 0.10
Nodes (17): parseCV(), sanitizeCVText(), applyTesterInvite(), GET(), GET(), getBaseUrl(), POST(), POST() (+9 more)
...
Cohesion: 0.08
Nodes (30): AIUsage, UsageDetails(), UsageIndicator(), UsageIndicatorProps, QuickAction, QuickActions(), QuickActionsProps, getScoreTheme() (+22 more)

### Community 29 - "Search Route & Query Prep"
Cohesion: 0.15
Nodes (20): getUserLearnedPreferences(), injectDiversity(), mergeExplicitWithLearnedPreferences(), GeneratedQueries, QueryGenerationInput, getCompanySizeCategory(), mapIndustriesToTaxonomyFilter(), mapWorkArrangementsToFilter() (+12 more)
...
Cohesion: 0.14
Nodes (19): UpgradeModalEventDetail, COUNTRY_PHONE_CODES, CVGeneratorDialog(), CVGeneratorDialogProps, EducationEntry, getPhoneCodeFromCountry(), WorkHistoryEntry, JobContext (+11 more)
...
Cohesion: 0.21
Nodes (11): ChatButton(), ChatHeader(), ChatPanel(), ChatPanelProps, getPageContext(), PAGE_CONTEXT_HINTS, ChatProvider(), ChatState (+3 more)
...
Cohesion: 0.14
Nodes (18): Feature, FEATURE_INFO, FeatureAccessResult, useFeatureAccess(), COMPANY_SIZES, MATCH_LEVELS, PRO_FILTER_FEATURES, SENIORITY_LEVELS (+10 more)
...
Cohesion: 0.09
Nodes (19): JobAIChat(), JobAIChatProps, Message, MessageInput(), MessageInputProps, ThemeToggle(), DEGREE_OPTIONS, DEGREE_REGIONS (+11 more)

### Community 114 - "Community 114"
Cohesion: 0.06
Nodes (46): AggregatedPreferences, aggregatePreferences(), computeConfidence(), computeUserPreferences(), CONFIDENCE_THRESHOLDS, ExtractedFeatures, extractJobFeatures(), extractKeywords() (+38 more)
...
Cohesion: 0.18
Nodes (9): AdminPage(), FavoriteButton(), FavoriteButtonProps, sizeConfig, useToast(), JobDetailPage(), LoginPageContent(), ProfilePageContent() (+1 more)
...
- **Why does `cn()` connect `Setup Wizard & Filter Validation` to `Plans & AI Usage Tracking`, `Dashboard Page & UI Primitives`, `NPM Dependencies`, `Landing Page UI`, `Account & Subscription Pages`, `Public Pages & Footer`, `Chat Panel Components`, `Dialog Components`, `Preference Scoring`, `Pricing & Plan Selection`, `CV Text Extraction`, `Community 104`, `Community 107`, `Community 110`, `Community 111`, `Community 113`, `Community 117`, `Community 120`, `Community 122`?**
