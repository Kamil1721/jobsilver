# Graph Report - jobsilver  (2026-05-21)

## Corpus Check
- 339 files · ~291,758 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2141 nodes · 4367 edges · 128 communities (117 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b33c2c4a`
...
5. `createServiceClient()` - 54 edges
...
Cohesion: 0.17
Nodes (16): formatPreferencesForAI(), getGeneralHelp(), getHelpForPage(), WEBSITE_HELP, buildJobContext(), buildUserContext(), CVData, formatJobContextForPrompt() (+8 more)

### Community 1 - "Chat State & Events"
Cohesion: 0.10
Nodes (16): ChatProviderProps, VALID_PAGE_PATHNAMES, ValidPathname, AttachFilePayload, CHAT_EVENTS, ChatEventType, dispatchAttachFile(), dispatchFillMultipleAnswers() (+8 more)

### Community 2 - "Job Card UI & Utils"
Cohesion: 0.15
Nodes (16): Feature, FEATURE_INFO, FeatureAccessResult, useFeatureAccess(), COMPANY_SIZES, MATCH_LEVELS, PRO_FILTER_FEATURES, SENIORITY_LEVELS (+8 more)

### Community 3 - "Dashboard Page & UI Primitives"
Cohesion: 0.08
Nodes (39): DOWNGRADE_REASONS, formatPeriodEndDate(), getLostFeatures(), mapPlanToFeatureKey(), PLAN_FEATURE_DISPLAY, PlanChangeDialog(), PlanChangeDialogProps, PlanFeatureKey (+31 more)

### Community 4 - "Community 4"
Cohesion: 0.14
Nodes (21): ApplicationQuestion, Action, ActionType, actionTypes, addMessage(), ChatState, clearMessages(), closeChat() (+13 more)
...
Cohesion: 0.13
Nodes (40): GET(), getUserPreferences(), GET(), GET(), POST(), GET(), GET_RATE_LIMIT_CONFIG, POST() (+32 more)

### Community 8 - "Setup Wizard Form Steps"
Cohesion: 0.10
Nodes (19): DEGREE_OPTIONS, DEGREE_REGIONS, DegreeCombobox(), EducationEntry, EducationSectionProps, EMPTY_ENTRY, EMPTY_ENTRY, WorkHistoryEntry (+11 more)

### Community 9 - "CV PDF Generation"
Cohesion: 0.07
Nodes (35): generateBasicTailoredContent(), JobContext, openai, shouldUseAITailoring(), tailorCVForJob(), TailoredContent, mapParsedCVToScreeningAnswers(), MappingResult (+27 more)
...
Cohesion: 0.23
Nodes (10): ChatHeaderProps, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem, DropdownMenuSeparator, DropdownMenuShortcut() (+2 more)

### Community 12 - "Account & Subscription Pages"
Cohesion: 0.09
Nodes (25): AnswerValue, CvUploadState, INITIAL_CV, NormalizedQuestion, QuestionsResponse, QuestionType, StatusResponse, TERMINAL_STATUSES (+17 more)

### Community 13 - "Announcements & Notifications"
Cohesion: 0.05
Nodes (39): AdminAnnouncement, AdminAuditLog, AdminAuditLogWithAdmin, AIUsageStats, AIUsageWithLimits, ApplicationAnswer, ATSSource, AutoApplyMode (+31 more)

### Community 14 - "Public Pages & Footer"
Cohesion: 0.13
Nodes (9): PublicFooter(), PublicFooterProps, metadata, useTheme(), DashboardLayout(), FAQ_CATEGORIES, FAQItem(), metadata (+1 more)

### Community 15 - "Audit Logging & Admin Routes"
Cohesion: 0.15
Nodes (20): checkoutRequestSchema, getBaseUrl(), POST(), DELETE(), DowngradeReason, getStripeErrorMessage(), POST(), VALID_REASONS (+12 more)

### Community 16 - "Interaction Tracking"
Cohesion: 0.27
Nodes (12): extractTextFromDOCX(), extractTextFromFile(), extractTextFromPDF(), extractTextFromPDFAdobe(), extractTextFromPDFBasic(), openai, parseCV(), sanitizeCVText() (+4 more)

### Community 17 - "Supabase Server Client"
Cohesion: 0.10
Nodes (17): ANNOUNCEMENTS_RATE_LIMIT, VALID_PLANS, GET(), GET(), FEATURE_REQUIREMENTS, formatPlanName(), getRequiredPlan(), PLAN_HIERARCHY (+9 more)
...
Cohesion: 0.11
Nodes (17): POST(), checkRateLimitDistributed(), checkRateLimitInMemory(), InternalAuthOptions, InternalAuthResult, RateLimitConfig, RateLimitRecord, RateLimitResult (+9 more)
...
Cohesion: 0.11
Nodes (19): parseAshbyUrl(), ASHBY_BOARDS, AshbyCompany, ATS_STATS, findCompanyByName(), GREENHOUSE_BOARDS, GreenhouseCompany, LEVER_COMPANIES (+11 more)
...
Cohesion: 0.11
Nodes (20): getJobInteractionHistory(), getUserInteractionStats(), lastComputeTime, shouldTriggerRecompute(), trackInteractionAndLearn(), trackInteractionsBatch(), GET(), safeCompare() (+12 more)

### Community 25 - "Chat Panel Components"
Cohesion: 0.29
Nodes (6): countries, Country, formatPhoneNumber(), parsePhoneNumber(), PhoneInput(), PhoneInputProps
...
Cohesion: 0.14
Nodes (20): CATEGORY_WEIGHTS, computeFinalJobScore(), computePreferenceScore(), CONFIDENCE_INFLUENCE, extractKeywords(), FinalScoreResult, getUserLearnedPreferences(), injectDiversity() (+12 more)

### Community 28 - "Setup Wizard & Filter Validation"
Cohesion: 0.07
Nodes (30): AIUsage, UsageDetails(), UsageIndicator(), UsageIndicatorProps, ThemeToggle(), UpgradeModal(), FavoriteButtonProps, sizeConfig (+22 more)

### Community 29 - "Search Route & Query Prep"
Cohesion: 0.16
Nodes (18): getCompanySizeCategory(), mapIndustriesToTaxonomyFilter(), mapWorkArrangementsToFilter(), searchATSJobs(), checkAndUpdateQuota(), detectPlatform(), getPlanJobLimit(), getQuotaStatus() (+10 more)

### Community 30 - "Multi-Source ATS Search"
Cohesion: 0.17
Nodes (19): searchAshbyJobs(), getAshbyBoards(), getGreenhouseBoards(), getLeverCompanies(), createJobFingerprint(), JobSourceConfig, normalizeLocation(), normalizeTitle() (+11 more)

### Community 31 - "Dialog Components"
Cohesion: 0.08
Nodes (31): MessageInput(), MessageInputProps, UpgradeModalEventDetail, COUNTRY_PHONE_CODES, CVGeneratorDialog(), CVGeneratorDialogProps, EducationEntry, getPhoneCodeFromCountry() (+23 more)

### Community 32 - "Job Matching Route"
Cohesion: 0.23
Nodes (12): generateApplicationQuestions(), applicationAnswersSchema, CONTENT_TYPES, CV_DIR, DELETE(), errorResponse(), GET(), isValidJobStatus() (+4 more)
...
Cohesion: 0.15
Nodes (16): Action, ActionType, actionTypes, addToRemoveQueue(), clearToastState(), dispatch(), genId(), listeners (+8 more)

### Community 36 - "Layout Provider & Cookie Consent"
Cohesion: 0.20
Nodes (7): fraunces, inter, metadata, ConsentStatus, CookieConsent, CookieConsentBanner(), Toaster()

### Community 37 - "Preference Scoring"
Cohesion: 0.21
Nodes (8): formatMarkdown(), MessageItem(), MessageItemProps, MessageList(), MessageListProps, TypingIndicator(), dispatchFillAnswer(), ChatMessage
...
Cohesion: 0.15
Nodes (14): detectRemoteType(), fetchGreenhouseJobWithQuestions(), getGreenhouseJob(), GreenhouseBoardInfo, GreenhouseDepartment, GreenhouseJob, GreenhouseJobsResponse, GreenhouseLocation (+6 more)
...
Cohesion: 0.16
Nodes (16): buildDescription(), detectRemoteType(), fetchLeverPostings(), fetchLeverPostingsByGroup(), generateLeverQuestions(), LeverApplicationForm, LeverCategory, LeverCustomQuestion (+8 more)
...
Cohesion: 0.11
Nodes (25): AdminAuthResult, getAdminEmails(), getRedactedAdminEmails(), isAdminEmail(), adminUserDeleteSchema, adminUsersQuerySchema, adminUserUpdateSchema, apiUsageActionSchema (+17 more)
...
Cohesion: 0.04
Nodes (46): 1. User Tiers / Subscription Plans, 2. Auto-Apply Modes, 3. Application Flow, 4. Quotas System, 5. Supported ATS Platforms, 6. Database Tables Summary, Aggregators (Redirect Elsewhere), API-Enabled (Questions from API) (+38 more)
...
Cohesion: 0.15
Nodes (13): ParsedCV, buildFallbackQueries(), buildQueryInput(), calculateYearsExperience(), determineMarket(), GeneratedQueries, generateSearchQueries(), getQueriesForAPI() (+5 more)
...
Cohesion: 0.19
Nodes (12): ChatButton(), ChatHeader(), ChatPanel(), ChatPanelProps, getPageContext(), PAGE_CONTEXT_HINTS, ChatProvider(), QuickAction (+4 more)
...
Cohesion: 0.38
Nodes (5): ThemeProvider(), ThemeProviderProps, Theme, ThemeContext, ThemeContextValue

### Community 100 - "Community 100"
Cohesion: 0.05
Nodes (40): 10. Open Questions, 1. API Overview, 2. Supported Countries, 3. Search Parameters, 4. Response Format, 5.1 Type Definitions, 5.2 Supported Country Codes Constant, 5.3 Search Function (+32 more)

### Community 101 - "Community 101"
Cohesion: 0.13
Nodes (32): checkAdminAuth(), announcementTypeSchema, createAnnouncementSchema, DELETE(), deleteAnnouncementSchema, PATCH(), POST(), updateAnnouncementSchema (+24 more)

### Community 102 - "Community 102"
Cohesion: 0.07
Nodes (28): Auto-Apply Milestone 1 — Job-Detail Question UI — Implementation Plan, code:sql (-- Auto-apply Milestone 1: extracted questions (shared per p), code:bash (git add src/lib/auto-apply/profile-prefill.ts), code:bash (git add src/app/api/auto-apply), code:bash (git add src/components/auto-apply/phone-field.tsx), code:bash (git add src/components/auto-apply/application-form.tsx), code:bash (git add "src/app/(dashboard)/jobs/[id]/page.tsx"), code:bash (git add supabase/migrations/20260521000000_add_auto_apply_qu) (+20 more)

### Community 103 - "Community 103"
Cohesion: 0.07
Nodes (26): ATS Public APIs (No Auth Required), code:json ({), code:typescript (interface UserSubmittedCompany {), code:typescript (async function validateGreenhouseBoard(token: string): Promi), code:typescript (// When user pastes any careers page URL), Commercial Data Providers, Data Quality Considerations, Free Company Discovery Sources (+18 more)

### Community 104 - "Community 104"
Cohesion: 0.07
Nodes (35): JobAIChat(), JobAIChatProps, Message, SubscriptionContext, SubscriptionContextValue, SubscriptionData, SubscriptionProvider(), SubscriptionProviderProps (+27 more)

### Community 105 - "Community 105"
Cohesion: 0.08
Nodes (24): 2026-01-23 - Infrastructure & Security, 2026-01-24 - AI Learning System, 2026-01-25 - Tester System & Security, 2026-01-28 - AI Assistant Pivot, 2026-01-29 - Auto-Apply System Removal, 2026-01 - January, 2026-02-02 - Security & Routing Fixes, 2026-02-03 - Email System Fixes (+16 more)

### Community 106 - "Community 106"
Cohesion: 0.08
Nodes (23): 10.1 Skyvern Credit Cost Controls, 10. Quota, Gating & Pricing Tie-In, 11. Dependencies & Open Items, 12.1 Skyvern per-field verification is unproven (HIGH RISK), 12.2 Pricing must be solvable (HIGH RISK — constrains sub-project C), 12.3 Smaller open items for the implementation plan, 12. Assumptions & Risks, 13. Success Criteria (+15 more)
...
Cohesion: 0.11
Nodes (18): Architecture Overview, code:block1 (src/), code:bash (# 1. Clone & install), Cron Jobs (configured in vercel.json), Deployment (Vercel), Environment Variables, Getting Started, Job Sources (+10 more)

### Community 109 - "Community 109"
Cohesion: 0.29
Nodes (5): ChatMessage, ChatResponse, createCoverLetterDoc(), downloadCoverLetter(), AskAIHelpPayload

### Community 110 - "Community 110"
Cohesion: 0.09
Nodes (10): BillingCycle, FAQ_ITEMS, FAQItem(), Plan, PLANS, PricingCard(), PricingFeature, PricingPageContent() (+2 more)

### Community 111 - "Community 111"
Cohesion: 0.20
Nodes (11): errorResponse(), FIELD_TYPE_MAP, GET(), GreenhouseField, GreenhouseFieldValue, GreenhouseJob, GreenhouseQuestion, NormalizedQuestion (+3 more)

### Community 112 - "Community 112"
Cohesion: 0.22
Nodes (8): calculateJobMatch(), CVData, FiltersData, MatchResult, openai, sanitizeForAIPrompt(), ScreeningData, ApplicationQuestion

### Community 113 - "Community 113"
Cohesion: 0.06
Nodes (38): SKILL_PRESETS, SkillsSection(), SkillsSectionProps, INDUSTRY_CATEGORIES, JOB_TITLES_BY_INDUSTRY, CURRENCY_SYMBOLS, formatSalary(), getCurrencySymbol() (+30 more)
...
Cohesion: 0.24
Nodes (16): AIFeature, canUseAI(), CanUseAIResult, CanUseFeatureResult, checkCanUseFeature(), checkNearLimits(), DailyUsageStats, featureToResource() (+8 more)

### Community 116 - "Community 116"
Cohesion: 0.22
Nodes (8): FilterValidationError, FilterValidationResult, getMissingScreeningFields(), isMandatoryScreeningFieldValid(), validateMandatoryFilters(), validateScreeningAnswers(), ValidationError, ValidationResult

### Community 117 - "Community 117"
Cohesion: 0.33
Nodes (6): AnnouncementBanner(), AnnouncementBannerProps, DismissedRecord, getTypeStyles(), ActiveAnnouncement, AnnouncementType

### Community 118 - "Community 118"
Cohesion: 0.25
Nodes (7): Features, How to Apply, Subject Lines, Supabase Email Templates, Template Files, Template Variables, Testing

### Community 119 - "Community 119"
Cohesion: 0.16
Nodes (18): AIResource, formatPlanName(), getDailyAIResponseQuota(), getDailyApplicationQuota(), getDailyCoverLetterQuota(), getDailyCVGenerationQuota(), getDailyJobLimit(), getDailyJobQuota() (+10 more)

### Community 120 - "Community 120"
Cohesion: 0.26
Nodes (13): incrementUsage(), chatTools, handleAttachCoverLetter(), handleGenerateAnswer(), handleGenerateCoverLetter(), handleGetJobDetails(), handleGetUserJobs(), handleGetUserPreferences() (+5 more)

### Community 121 - "Community 121"
Cohesion: 0.48
Nodes (6): buildSearchQueries(), curateJobsForUser(), CurationResult, fetchPersonalizedJobs(), getInternalCallUserId(), POST()

### Community 123 - "Community 123"
Cohesion: 0.53
Nodes (5): ApplyBody, buildCvUrl(), errorResponse(), POST(), schemaKey()

### Community 124 - "Community 124"
Cohesion: 0.47
Nodes (5): ALLOWED, CV_DIR, errorResponse(), POST(), sanitizeName()

### Community 126 - "Community 126"
Cohesion: 0.07
Nodes (31): classifySemanticType(), computePostingKey(), detectAts(), parseAshbyUrl(), parseGreenhouseUrl(), parseLeverUrl(), DbQuestionRow, ApplicationQuestion (+23 more)

### Community 127 - "Community 127"
Cohesion: 0.33
Nodes (6): autoFillAnswers(), AutoFillResult, MatchableQuestion, optionValue(), POC_TEST_PROFILE, PocProfile

## Knowledge Gaps
- **800 isolated node(s):** `DbQuestionRow`, `AshbyFieldEntry`, `AshbyFormSection`, `AshbyApplicationForm`, `AshbyJobPosting` (+795 more)
...
- **Why does `cn()` connect `Setup Wizard & Filter Validation` to `Job Card UI & Utils`, `Dashboard Page & UI Primitives`, `Community 4`, `NPM Dependencies`, `Setup Wizard Form Steps`, `Landing Page UI`, `Subscription Context & Feature Gate`, `Account & Subscription Pages`, `Public Pages & Footer`, `Chat Panel Components`, `Dialog Components`, `Preference Scoring`, `Pricing & Plan Selection`, `CV Text Extraction`, `Community 104`, `Community 107`, `Community 110`, `Community 113`, `Community 117`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `dependencies` connect `NPM Dependencies` to `Package Scripts`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `clsx` connect `NPM Dependencies` to `Setup Wizard & Filter Validation`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **What connects `DbQuestionRow`, `AshbyFieldEntry`, `AshbyFormSection` to the rest of the system?**
...
- **Should `Dashboard Page & UI Primitives` be split into smaller, more focused modules?**
