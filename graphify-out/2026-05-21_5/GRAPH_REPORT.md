...
## Corpus Check
- 333 files · ~289,333 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2113 nodes · 4310 edges · 122 communities (111 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5142e77f`
...
Cohesion: 0.07
Nodes (36): CATEGORY_WEIGHTS, computeFinalJobScore(), computePreferenceScore(), CONFIDENCE_INFLUENCE, extractKeywords(), FinalScoreResult, formatPreferencesForAI(), getUserLearnedPreferences() (+28 more)

### Community 1 - "Chat State & Events"
Cohesion: 0.05
Nodes (49): ChatMessage, ChatResponse, createCoverLetterDoc(), downloadCoverLetter(), ChatProvider(), ChatProviderProps, VALID_PAGE_PATHNAMES, ValidPathname (+41 more)

### Community 2 - "Job Card UI & Utils"
Cohesion: 0.05
Nodes (55): AIUsage, UsageDetails(), UsageIndicator(), UsageIndicatorProps, ChatButton(), ChatHeader(), ChatHeaderProps, ChatPanel() (+47 more)

### Community 3 - "Dashboard Page & UI Primitives"
Cohesion: 0.07
Nodes (42): DOWNGRADE_REASONS, formatPeriodEndDate(), getLostFeatures(), mapPlanToFeatureKey(), PLAN_FEATURE_DISPLAY, PlanChangeDialog(), PlanChangeDialogProps, PlanFeatureKey (+34 more)

### Community 4 - "Community 4"
Cohesion: 0.15
Nodes (15): shouldUseAITailoring(), mapParsedCVToScreeningAnswers(), MappingResult, ParsedCV, parseLocation(), parsePhone(), splitName(), generateTailoredCV() (+7 more)
...
Cohesion: 0.14
Nodes (46): GET(), checkAdminAuth(), announcementTypeSchema, createAnnouncementSchema, DELETE(), deleteAnnouncementSchema, GET(), PATCH() (+38 more)

### Community 8 - "Setup Wizard Form Steps"
Cohesion: 0.07
Nodes (34): MessageInputProps, COUNTRY_PHONE_CODES, CVGeneratorDialog(), CVGeneratorDialogProps, EducationEntry, getPhoneCodeFromCountry(), WorkHistoryEntry, DEGREE_OPTIONS (+26 more)

### Community 9 - "CV PDF Generation"
Cohesion: 0.19
Nodes (11): ACCENT_COLOR, Education, formatDateRange(), generateCV(), JobContext, LIGHT_GRAY, PDFHelper, PRIMARY_COLOR (+3 more)
...
Cohesion: 0.15
Nodes (16): generateBasicTailoredContent(), JobContext, openai, tailorCVForJob(), TailoredContent, CVData, sanitizeAIOutput(), sanitizeForPrompt() (+8 more)

### Community 12 - "Account & Subscription Pages"
Cohesion: 0.11
Nodes (20): AnswerValue, CvUploadState, INITIAL_CV, NormalizedQuestion, QuestionsResponse, QuestionType, StatusResponse, TERMINAL_STATUSES (+12 more)
...
Cohesion: 0.08
Nodes (25): ANNOUNCEMENTS_RATE_LIMIT, VALID_PLANS, applyTesterInvite(), GET(), GET(), safeCompare(), buildSearchQueries(), curateJobsForUser() (+17 more)

### Community 17 - "Supabase Server Client"
Cohesion: 0.18
Nodes (13): GET(), canAccessFeature(), FEATURE_REQUIREMENTS, formatPlanName(), getRequiredPlan(), PLAN_HIERARCHY, SUBSCRIPTION_PLAN_HIERARCHY, GET() (+5 more)
...
Cohesion: 0.17
Nodes (17): AIResource, getDailyAIResponseQuota(), getDailyApplicationQuota(), getDailyCoverLetterQuota(), getDailyCVGenerationQuota(), getDailyJobLimit(), getDailyJobQuota(), getEmailFrequency() (+9 more)
...
Cohesion: 0.07
Nodes (31): AdminPage(), SKILL_PRESETS, SkillsSection(), SkillsSectionProps, useToast(), JobNotes(), JobNotesProps, SaveStatus (+23 more)
...
Cohesion: 0.08
Nodes (31): UpgradeModal(), SubscriptionContext, SubscriptionContextValue, SubscriptionData, SubscriptionProvider(), SubscriptionProviderProps, useSubscription(), FavoriteButton() (+23 more)
...
Cohesion: 0.12
Nodes (17): JobAIChat(), JobAIChatProps, Message, JobCard(), JobCardProps, JobCardSkeleton(), ColumnStatus, containerVariants (+9 more)
...
Cohesion: 0.13
Nodes (7): ApplicationQuestion, AtsPlatform, ExtractionResult, FieldType, PrefilledQuestion, QuestionOption, SemanticType

## Knowledge Gaps
- **793 isolated node(s):** `QuestionOption`, `ApplicationQuestion`, `ExtractionResult`, `PrefilledQuestion`, `$schema` (+788 more)
...
- **Why does `cn()` connect `Job Card UI & Utils` to `Chat State & Events`, `Dashboard Page & UI Primitives`, `NPM Dependencies`, `Community 104`, `Setup Wizard Form Steps`, `Landing Page UI`, `Community 107`, `Account & Subscription Pages`, `Toast Hook`, `Community 110`, `Public Pages & Footer`, `Announcements & Notifications`, `Pricing & Plan Selection`, `Setup Wizard & Filter Validation`, `Dialog Components`?**
...
- **Why does `clsx` connect `NPM Dependencies` to `Job Card UI & Utils`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **What connects `QuestionOption`, `ApplicationQuestion`, `ExtractionResult` to the rest of the system?**
