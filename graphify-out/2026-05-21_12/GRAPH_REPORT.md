...
## Corpus Check
- 343 files · ~293,679 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2158 nodes · 4389 edges · 130 communities (118 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bd1d620f`
...
Cohesion: 0.09
Nodes (24): DEGREE_OPTIONS, DEGREE_REGIONS, DegreeCombobox(), EducationEntry, EducationSectionProps, EMPTY_ENTRY, EMPTY_ENTRY, WorkHistoryEntry (+16 more)

### Community 1 - "Chat State & Events"
Cohesion: 0.11
Nodes (15): ChatProviderProps, VALID_PAGE_PATHNAMES, ValidPathname, AttachFilePayload, CHAT_EVENTS, ChatEventType, dispatchAttachFile(), dispatchFillMultipleAnswers() (+7 more)

### Community 3 - "Dashboard Page & UI Primitives"
Cohesion: 0.12
Nodes (25): DOWNGRADE_REASONS, formatPeriodEndDate(), getLostFeatures(), mapPlanToFeatureKey(), PLAN_FEATURE_DISPLAY, PlanChangeDialog(), PlanChangeDialogProps, PlanFeatureKey (+17 more)

### Community 4 - "Community 4"
Cohesion: 0.15
Nodes (19): ApplicationQuestion, Action, ActionType, actionTypes, addMessage(), ChatState, dispatch(), genId() (+11 more)
...
Cohesion: 0.11
Nodes (24): DELETE(), favoriteSchema, GET(), POST(), GET(), canAccessFeature(), Feature, FEATURE_INFO (+16 more)

### Community 8 - "Setup Wizard Form Steps"
Cohesion: 0.22
Nodes (17): AIFeature, canUseAI(), CanUseAIResult, CanUseFeatureResult, checkCanUseFeature(), checkNearLimits(), DailyUsageStats, featureToResource() (+9 more)
...
Cohesion: 0.18
Nodes (16): formatPlanName(), getDailyAIResponseQuota(), getDailyApplicationQuota(), getDailyCoverLetterQuota(), getDailyCVGenerationQuota(), getDailyJobLimit(), getDailyJobQuota(), getEmailFrequency() (+8 more)

### Community 12 - "Account & Subscription Pages"
Cohesion: 0.06
Nodes (41): ReportStats, Tester, TesterInvite, TesterInviteStatus, TesterStats, User, UserReport, AnswerValue (+33 more)

### Community 13 - "Announcements & Notifications"
Cohesion: 0.05
Nodes (36): AdminAnnouncement, AdminAuditLog, AdminAuditLogWithAdmin, AIUsageStats, AIUsageWithLimits, ApplicationAnswer, ATSSource, AutoApplyMode (+28 more)

### Community 14 - "Public Pages & Footer"
Cohesion: 0.13
Nodes (17): ApplicationForm(), UpgradeModal(), useSubscription(), JobCard(), JobCardProps, JobCardSkeleton(), ColumnStatus, containerVariants (+9 more)
...
Cohesion: 0.09
Nodes (19): ANNOUNCEMENTS_RATE_LIMIT, VALID_PLANS, POST(), checkRateLimitDistributed(), checkRateLimitInMemory(), InternalAuthOptions, InternalAuthResult, RateLimitConfig (+11 more)
...
Cohesion: 0.10
Nodes (19): GET(), safeCompare(), buildSearchQueries(), curateJobsForUser(), CurationResult, fetchPersonalizedJobs(), getInternalCallUserId(), POST() (+11 more)

### Community 25 - "Chat Panel Components"
Cohesion: 0.08
Nodes (26): AnswerValue, ApplicationFormProps, isMultiselect(), QuestionsResponse, SaveState, seedAnswer(), UNSUPPORTED_MESSAGES, UnsupportedReason (+18 more)
...
Cohesion: 0.07
Nodes (36): AIUsage, UsageDetails(), UsageIndicator(), UsageIndicatorProps, ChatPanel(), ChatPanelProps, getPageContext(), PAGE_CONTEXT_HINTS (+28 more)

### Community 29 - "Search Route & Query Prep"
Cohesion: 0.12
Nodes (24): injectDiversity(), mergeExplicitWithLearnedPreferences(), GeneratedQueries, QueryGenerationInput, getCompanySizeCategory(), mapIndustriesToTaxonomyFilter(), mapWorkArrangementsToFilter(), computeProfileHash() (+16 more)

### Community 30 - "Multi-Source ATS Search"
Cohesion: 0.15
Nodes (22): searchAshbyJobs(), getAshbyBoards(), getGreenhouseBoards(), getLeverCompanies(), FantasticJobsSearchParams, searchGreenhouseJobs(), searchATSJobs(), createJobFingerprint() (+14 more)

### Community 31 - "Dialog Components"
Cohesion: 0.07
Nodes (36): JobAIChat(), JobAIChatProps, Message, UpgradeModalEventDetail, AdminPage(), COUNTRY_PHONE_CODES, CVGeneratorDialog(), CVGeneratorDialogProps (+28 more)
...
Cohesion: 0.18
Nodes (8): fraunces, inter, metadata, ConsentStatus, CookieConsent, CookieConsentBanner(), ThemeProvider(), Toaster()

### Community 37 - "Preference Scoring"
Cohesion: 0.15
Nodes (12): ChatButton(), ChatHeader(), ChatProvider(), formatMarkdown(), MessageItem(), MessageItemProps, MessageList(), MessageListProps (+4 more)
...
Cohesion: 0.17
Nodes (15): buildDescription(), detectRemoteType(), fetchLeverPostings(), fetchLeverPostingsByGroup(), generateLeverQuestions(), LeverApplicationForm, LeverCategory, LeverCustomQuestion (+7 more)
...
Cohesion: 0.10
Nodes (62): GET(), checkAdminAuth(), announcementTypeSchema, createAnnouncementSchema, DELETE(), deleteAnnouncementSchema, GET(), PATCH() (+54 more)
...
Cohesion: 0.27
Nodes (8): ParsedCV, buildFallbackQueries(), buildQueryInput(), calculateYearsExperience(), determineMarket(), generateSearchQueries(), getQueriesForAPI(), openai
...
Cohesion: 0.60
Nodes (4): AdminAuthResult, getAdminEmails(), getRedactedAdminEmails(), isAdminEmail()
...
Cohesion: 0.40
Nodes (4): openai, POST(), sanitizeInput(), SuggestSkillsRequest
...
Cohesion: 0.22
Nodes (12): AuditEventType, auditLog(), AuditLogEntry, AuditSeverity, generateRequestId(), getClientIp(), logAuthEvent(), logSecurityIncident() (+4 more)
...
Cohesion: 0.17
Nodes (15): useFeatureAccess(), COMPANY_SIZES, MATCH_LEVELS, PRO_FILTER_FEATURES, SENIORITY_LEVELS, StepJobFilters(), StepJobFiltersProps, TIME_ZONES (+7 more)
...
Cohesion: 0.07
Nodes (25): SKILL_PRESETS, SkillsSection(), SkillsSectionProps, INDUSTRY_CATEGORIES, JOB_TITLES_BY_INDUSTRY, DEFAULT_JOB_FILTERS, DEFAULT_SCREENING_ANSWERS, SetupWizard() (+17 more)
...
Cohesion: 0.47
Nodes (4): ThemeProviderProps, Theme, ThemeContext, ThemeContextValue
...
Cohesion: 0.16
Nodes (18): formatPreferencesForAI(), getUserLearnedPreferences(), getGeneralHelp(), getHelpForPage(), WEBSITE_HELP, buildJobContext(), buildUserContext(), CVData (+10 more)

### Community 121 - "Community 121"
Cohesion: 0.29
Nodes (12): incrementUsage(), handleAttachCoverLetter(), handleGenerateAnswer(), handleGenerateCoverLetter(), handleGetJobDetails(), handleGetUserJobs(), handleGetUserPreferences(), handleGetUserProfile() (+4 more)

### Community 122 - "Community 122"
Cohesion: 0.13
Nodes (17): ChatHeaderProps, SystemMessage, clearChatState(), clearMessages(), closeChat(), Avatar, AvatarFallback, AvatarImage (+9 more)
...
Cohesion: 0.05
Nodes (46): answersBodySchema, classifySemanticType(), computePostingKey(), detectAts(), parseAshbyUrl(), parseGreenhouseUrl(), parseLeverUrl(), prefillFromProfile() (+38 more)
...
## Knowledge Gaps
- **808 isolated node(s):** `ApplicationFormProps`, `UnsupportedReason`, `QuestionsResponse`, `AnswerValue`, `SaveState` (+803 more)
...
- **Why does `cn()` connect `Setup Wizard & Filter Validation` to `Plans & AI Usage Tracking`, `Dashboard Page & UI Primitives`, `Community 4`, `NPM Dependencies`, `Preference Scoring`, `Community 104`, `Pricing & Plan Selection`, `Landing Page UI`, `Community 107`, `Account & Subscription Pages`, `Community 110`, `Community 111`, `Public Pages & Footer`, `Community 113`, `Community 117`, `Chat Panel Components`, `Community 122`, `Dialog Components`?**
...
- **What connects `ApplicationFormProps`, `UnsupportedReason`, `QuestionsResponse` to the rest of the system?**
