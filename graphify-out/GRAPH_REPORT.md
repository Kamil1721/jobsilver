...
## Corpus Check
- 343 files · ~294,029 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2163 nodes · 4440 edges · 132 communities (120 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8c2e0f48`
...
Cohesion: 0.07
Nodes (36): AdminPage(), COUNTRY_PHONE_CODES, CVGeneratorDialog(), CVGeneratorDialogProps, EducationEntry, getPhoneCodeFromCountry(), WorkHistoryEntry, SKILL_PRESETS (+28 more)
...
Cohesion: 0.08
Nodes (37): DOWNGRADE_REASONS, formatPeriodEndDate(), getLostFeatures(), mapPlanToFeatureKey(), PLAN_FEATURE_DISPLAY, PlanChangeDialog(), PlanChangeDialogProps, PlanFeatureKey (+29 more)

### Community 4 - "Community 4"
Cohesion: 0.14
Nodes (22): ChatHeaderProps, ApplicationQuestion, Action, ActionType, actionTypes, addMessage(), ChatState, clearMessages() (+14 more)
...
Cohesion: 0.14
Nodes (35): ANNOUNCEMENTS_RATE_LIMIT, GET(), VALID_PLANS, GET(), GET(), DELETE(), favoriteSchema, GET() (+27 more)
...
Cohesion: 0.17
Nodes (17): AIResource, formatPlanName(), getDailyAIResponseQuota(), getDailyApplicationQuota(), getDailyCoverLetterQuota(), getDailyCVGenerationQuota(), getDailyJobLimit(), getDailyJobQuota() (+9 more)

### Community 12 - "Account & Subscription Pages"
Cohesion: 0.12
Nodes (19): AnswerValue, CvUploadState, INITIAL_CV, NormalizedQuestion, QuestionsResponse, QuestionType, StatusResponse, TERMINAL_STATUSES (+11 more)
...
Cohesion: 0.09
Nodes (25): JobCard(), JobCardProps, JobCardSkeleton(), ColumnStatus, containerVariants, itemVariants, KanbanColumnProps, statusColors (+17 more)

### Community 15 - "Audit Logging & Admin Routes"
Cohesion: 0.11
Nodes (16): JobAIChat(), JobAIChatProps, Message, MessageInput(), MessageInputProps, DEGREE_OPTIONS, DEGREE_REGIONS, DegreeCombobox() (+8 more)

### Community 16 - "Interaction Tracking"
Cohesion: 0.24
Nodes (13): extractTextFromDOCX(), extractTextFromFile(), extractTextFromPDF(), extractTextFromPDFAdobe(), extractTextFromPDFBasic(), openai, parseCV(), ParsedCV (+5 more)
...
Cohesion: 0.13
Nodes (13): POST(), checkRateLimitDistributed(), checkRateLimitInMemory(), InternalAuthOptions, InternalAuthResult, RateLimitConfig, RateLimitRecord, RateLimitResult (+5 more)

### Community 20 - "Fantastic.jobs Source"
Cohesion: 0.12
Nodes (24): ApiUsageInfo, checkGlobalQuota(), COMPANY_SIZE_RANGES, EmploymentTypeFilter, FantasticJobsJob, FantasticJobsResponse, INDUSTRY_KEYWORDS, isJobFresh() (+16 more)
...
Cohesion: 0.07
Nodes (34): GET(), safeCompare(), checkoutRequestSchema, getBaseUrl(), POST(), DowngradeReason, getStripeErrorMessage(), POST() (+26 more)

### Community 25 - "Chat Panel Components"
Cohesion: 0.15
Nodes (17): AnswerValue, ApplicationForm(), ApplicationFormProps, isMultiselect(), QuestionsResponse, SaveState, seedAnswer(), UNSUPPORTED_MESSAGES (+9 more)
...
Cohesion: 0.09
Nodes (28): AIUsage, UsageDetails(), UsageIndicator(), UsageIndicatorProps, FavoriteButton(), FavoriteButtonProps, sizeConfig, getScoreTheme() (+20 more)

### Community 29 - "Search Route & Query Prep"
Cohesion: 0.16
Nodes (18): GeneratedQueries, QueryGenerationInput, getCompanySizeCategory(), mapIndustriesToTaxonomyFilter(), mapWorkArrangementsToFilter(), computeProfileHash(), getCachedQueries(), setCachedQueries() (+10 more)

### Community 30 - "Multi-Source ATS Search"
Cohesion: 0.15
Nodes (22): searchAshbyJobs(), getAshbyBoards(), getGreenhouseBoards(), getLeverCompanies(), FantasticJobsSearchParams, searchGreenhouseJobs(), searchLeverJobs(), createJobFingerprint() (+14 more)

### Community 31 - "Dialog Components"
Cohesion: 0.07
Nodes (36): UpgradeModalEventDetail, ReportStats, Tester, TesterInvite, TesterInviteStatus, TesterStats, User, UserReport (+28 more)
...
Cohesion: 0.16
Nodes (15): Action, ActionType, actionTypes, addToRemoveQueue(), clearToastState(), dispatch(), genId(), listeners (+7 more)
...
Cohesion: 0.10
Nodes (22): buildDescription(), detectRemoteType(), fetchLeverPostings(), fetchLeverPostingsByGroup(), LeverApplicationForm, LeverCategory, LeverCustomQuestion, LeverFormField (+14 more)
...
Cohesion: 0.09
Nodes (46): AdminAuthResult, checkAdminAuth(), getAdminEmails(), getRedactedAdminEmails(), isAdminEmail(), announcementTypeSchema, createAnnouncementSchema, DELETE() (+38 more)
...
Cohesion: 0.31
Nodes (7): buildFallbackQueries(), buildQueryInput(), calculateYearsExperience(), determineMarket(), generateSearchQueries(), getQueriesForAPI(), openai
...
Cohesion: 0.21
Nodes (11): ChatButton(), ChatHeader(), ChatPanel(), ChatPanelProps, getPageContext(), PAGE_CONTEXT_HINTS, ChatProvider(), QuickAction (+3 more)
...
Cohesion: 0.29
Nodes (6): SubscriptionContext, SubscriptionContextValue, SubscriptionData, SubscriptionProvider(), SubscriptionProviderProps, PlanLimits
...
Cohesion: 0.26
Nodes (7): GET(), FEATURE_REQUIREMENTS, formatPlanName(), getRequiredPlan(), PLAN_HIERARCHY, SUBSCRIPTION_PLAN_HIERARCHY, GET()
...
Cohesion: 0.33
Nodes (5): countries, Country, formatPhoneNumber(), parsePhoneNumber(), PhoneInputProps
...
Cohesion: 0.18
Nodes (15): DELETE(), AuditEventType, auditLog(), AuditLogEntry, AuditSeverity, generateRequestId(), getClientIp(), logAccountEvent() (+7 more)
...
Cohesion: 0.27
Nodes (8): Feature, FEATURE_INFO, FeatureAccessResult, useFeatureAccess(), AllSubscriptionPlans, FeatureGateProps, LockedBadge(), LockedBadgeProps
...
Cohesion: 0.31
Nodes (8): Toast, ToastAction, ToastActionElement, ToastClose, ToastDescription, ToastTitle, toastVariants, ToastViewport
...
Cohesion: 0.25
Nodes (6): ChatMessage, ChatResponse, createCoverLetterDoc(), downloadCoverLetter(), AskAIHelpPayload, JobContextPayload

### Community 110 - "Community 110"
Cohesion: 0.14
Nodes (8): BillingCycle, FAQ_ITEMS, FAQItem(), Plan, PLANS, PricingCard(), PricingFeature, PricingPageContent()

### Community 111 - "Community 111"
Cohesion: 0.15
Nodes (7): PublicFooter(), PublicFooterProps, metadata, FAQ_CATEGORIES, FAQItem(), metadata, metadata

### Community 112 - "Community 112"
Cohesion: 0.20
Nodes (9): calculateJobMatch(), CVData, FiltersData, MatchResult, openai, sanitizeForAIPrompt(), ScreeningData, ApplicationQuestion (+1 more)

### Community 113 - "Community 113"
Cohesion: 0.14
Nodes (10): INDUSTRY_CATEGORIES, JOB_TITLES_BY_INDUSTRY, CATEGORY_ORDER, COUNTRIES, INDUSTRIES, INDUSTRIES_BY_CATEGORY, JOB_TYPES, StepJobPreferences() (+2 more)

### Community 114 - "Community 114"
Cohesion: 0.06
Nodes (40): AggregatedPreferences, aggregatePreferences(), computeConfidence(), computeUserPreferences(), CONFIDENCE_THRESHOLDS, ExtractedFeatures, extractJobFeatures(), extractKeywords() (+32 more)
...
Cohesion: 0.14
Nodes (17): ThemeToggle(), useTheme(), DashboardLayout(), SystemMessage, clearChatState(), Avatar, AvatarFallback, AvatarImage (+9 more)
...
Cohesion: 0.06
Nodes (47): answersBodySchema, PUT(), classifySemanticType(), computePostingKey(), detectAts(), parseAshbyUrl(), parseGreenhouseUrl(), parseLeverUrl() (+39 more)
...
Cohesion: 0.40
Nodes (5): COUNTRY_TIMEZONE_MAP, getJobTimezones(), hasFlexibleTimezone(), normalizeTimezone(), timezoneMatches()

### Community 131 - "Community 131"
Cohesion: 0.50
Nodes (4): openai, POST(), sanitizeInput(), SuggestAchievementsRequest

## Knowledge Gaps
- **796 isolated node(s):** `PhoneFieldProps`, `DbQuestionRow`, `FIELD_TYPE_MAP`, `GreenhouseFieldValue`, `GreenhouseField` (+791 more)
...
- **Why does `cn()` connect `Setup Wizard & Filter Validation` to `Plans & AI Usage Tracking`, `Dashboard Page & UI Primitives`, `Community 4`, `NPM Dependencies`, `Landing Page UI`, `Account & Subscription Pages`, `Public Pages & Footer`, `Audit Logging & Admin Routes`, `Chat Panel Components`, `Dialog Components`, `Preference Scoring`, `Pricing & Plan Selection`, `Description Formatting`, `Timezone Mapping`, `Community 104`, `Community 107`, `Community 110`, `Community 111`, `Community 113`, `Community 117`, `Community 122`?**
...
- **What connects `PhoneFieldProps`, `DbQuestionRow`, `FIELD_TYPE_MAP` to the rest of the system?**
