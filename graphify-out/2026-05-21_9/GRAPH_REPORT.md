...
## Corpus Check
- 341 files · ~292,515 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2145 nodes · 4379 edges · 125 communities (113 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `01296632`
...
Cohesion: 0.14
Nodes (10): INDUSTRY_CATEGORIES, JOB_TITLES_BY_INDUSTRY, CATEGORY_ORDER, COUNTRIES, INDUSTRIES, INDUSTRIES_BY_CATEGORY, JOB_TYPES, StepJobPreferencesProps (+2 more)
...
Cohesion: 0.14
Nodes (35): ANNOUNCEMENTS_RATE_LIMIT, GET(), VALID_PLANS, GET(), GET(), POST(), DELETE(), favoriteSchema (+27 more)

### Community 8 - "Setup Wizard Form Steps"
Cohesion: 0.16
Nodes (12): UpgradeModal(), useSubscription(), AdminPage(), FavoriteButton(), FavoriteButtonProps, sizeConfig, DashboardPageContent(), dispatchSetJobContext() (+4 more)
...
Cohesion: 0.06
Nodes (43): ReportStats, Tester, TesterInvite, TesterInviteStatus, TesterStats, User, UserReport, AnswerValue (+35 more)
...
Cohesion: 0.12
Nodes (15): PublicFooter(), PublicFooterProps, ThemeToggle(), metadata, useTheme(), DashboardLayout(), SystemMessage, clearChatState() (+7 more)
...
Cohesion: 0.20
Nodes (10): GET(), FEATURE_INFO, FEATURE_REQUIREMENTS, formatPlanName(), getRequiredPlan(), PLAN_HIERARCHY, SUBSCRIPTION_PLAN_HIERARCHY, FeatureAccessResult (+2 more)
...
Cohesion: 0.07
Nodes (34): getJobInteractionHistory(), getUserInteractionStats(), lastComputeTime, shouldTriggerRecompute(), trackInteractionAndLearn(), trackInteractionsBatch(), applyTesterInvite(), GET() (+26 more)
...
Cohesion: 0.06
Nodes (44): AIUsage, UsageDetails(), UsageIndicator(), UsageIndicatorProps, getScoreTheme(), PreferenceMatch(), PreferenceMatchProps, sizeConfig (+36 more)
...
Cohesion: 0.20
Nodes (9): ChatButton(), ChatHeader(), ChatProvider(), formatMarkdown(), MessageItem(), MessageItemProps, dispatchFillAnswer(), ChatMessage (+1 more)
...
Cohesion: 0.17
Nodes (11): ChatPanel(), ChatPanelProps, getPageContext(), PAGE_CONTEXT_HINTS, MessageList(), MessageListProps, QuickAction, QuickActions() (+3 more)
...
Cohesion: 0.14
Nodes (16): JobAIChat(), JobAIChatProps, Message, JobCard(), JobCardProps, JobCardSkeleton(), ColumnStatus, containerVariants (+8 more)
...
Cohesion: 0.06
Nodes (35): DEGREE_OPTIONS, DEGREE_REGIONS, DegreeCombobox(), EducationEntry, EducationSectionProps, EMPTY_ENTRY, SKILL_PRESETS, SkillsSection() (+27 more)

### Community 114 - "Community 114"
Cohesion: 0.09
Nodes (27): AggregatedPreferences, aggregatePreferences(), computeConfidence(), computeUserPreferences(), CONFIDENCE_THRESHOLDS, ExtractedFeatures, extractJobFeatures(), extractKeywords() (+19 more)

### Community 116 - "Community 116"
Cohesion: 0.20
Nodes (9): FilterValidationError, FilterValidationResult, getMissingScreeningFields(), isMandatoryScreeningFieldValid(), validateMandatoryFilters(), validateScreeningAnswers(), ValidationError, ValidationResult (+1 more)
...
Cohesion: 0.05
Nodes (64): formatPreferencesForAI(), AIFeature, canUseAI(), CanUseAIResult, CanUseFeatureResult, checkCanUseFeature(), checkNearLimits(), DailyUsageStats (+56 more)
...
## Knowledge Gaps
- **801 isolated node(s):** `answersBodySchema`, `DbQuestionRow`, `AshbyFieldEntry`, `AshbyFormSection`, `AshbyApplicationForm` (+796 more)
...
- **Why does `cn()` connect `Setup Wizard & Filter Validation` to `Plans & AI Usage Tracking`, `Dashboard Page & UI Primitives`, `Community 4`, `NPM Dependencies`, `Setup Wizard Form Steps`, `Landing Page UI`, `Subscription Context & Feature Gate`, `Account & Subscription Pages`, `Public Pages & Footer`, `Chat Panel Components`, `Dialog Components`, `Preference Scoring`, `Pricing & Plan Selection`, `CV Text Extraction`, `Community 104`, `Community 107`, `Community 110`, `Community 111`, `Community 113`, `Community 117`?**
...
- **What connects `answersBodySchema`, `DbQuestionRow`, `AshbyFieldEntry` to the rest of the system?**
