...
## Summary
- 2111 nodes · 4307 edges · 121 communities (111 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `39849f3d`
...
Cohesion: 0.05
Nodes (52): AIUsage, UsageDetails(), UsageIndicator(), UsageIndicatorProps, JobCard(), JobCardProps, JobCardSkeleton(), ColumnStatus (+44 more)

### Community 3 - "Dashboard Page & UI Primitives"
Cohesion: 0.14
Nodes (19): BulkActionsToolbar(), BulkActionsToolbarProps, ColumnId, columns, SearchFilters, UpgradeTeaser, QuotaDisplay(), QuotaDisplayProps (+11 more)
...
Cohesion: 0.10
Nodes (22): SKILL_PRESETS, SkillsSection(), SkillsSectionProps, EMPTY_ENTRY, WorkHistoryEntry, WorkHistorySectionProps, SearchBarProps, SearchFilters (+14 more)

### Community 9 - "CV PDF Generation"
Cohesion: 0.07
Nodes (33): generateBasicTailoredContent(), JobContext, openai, shouldUseAITailoring(), tailorCVForJob(), TailoredContent, mapParsedCVToScreeningAnswers(), MappingResult (+25 more)
...
Cohesion: 0.12
Nodes (17): parseCV(), sanitizeCVText(), GET(), POST(), sanitizeForPrompt(), openai, POST(), sanitizeInput() (+9 more)

### Community 12 - "Account & Subscription Pages"
Cohesion: 0.08
Nodes (31): AnswerValue, CvUploadState, INITIAL_CV, NormalizedQuestion, QuestionsResponse, QuestionType, StatusResponse, TERMINAL_STATUSES (+23 more)
...
Cohesion: 0.09
Nodes (17): PublicFooter(), PublicFooterProps, ThemeToggle(), UpgradeModal(), metadata, useTheme(), DashboardLayout(), SystemMessage (+9 more)
...
Cohesion: 0.13
Nodes (17): GET(), safeCompare(), buildSearchQueries(), curateJobsForUser(), CurationResult, fetchPersonalizedJobs(), getInternalCallUserId(), POST() (+9 more)
...
Cohesion: 0.11
Nodes (20): fetchWithRetry(), getJobDetails(), mapTheMuseJobToJob(), sanitizeString(), searchJobs(), searchJobsMultiCategory(), sleep(), THEMUSE_CATEGORIES (+12 more)
...
Cohesion: 0.15
Nodes (20): injectDiversity(), mergeExplicitWithLearnedPreferences(), GeneratedQueries, QueryGenerationInput, getCompanySizeCategory(), mapIndustriesToTaxonomyFilter(), mapWorkArrangementsToFilter(), computeProfileHash() (+12 more)

### Community 30 - "Multi-Source ATS Search"
Cohesion: 0.16
Nodes (21): searchAshbyJobs(), getAshbyBoards(), getGreenhouseBoards(), getLeverCompanies(), searchGreenhouseJobs(), searchLeverJobs(), createJobFingerprint(), JobSourceConfig (+13 more)

### Community 31 - "Dialog Components"
Cohesion: 0.07
Nodes (44): UpgradeModalEventDetail, AdminPage(), ReportStats, Tester, TesterInvite, TesterInviteStatus, TesterStats, User (+36 more)
...
Cohesion: 0.09
Nodes (21): fraunces, inter, metadata, ConsentStatus, CookieConsent, CookieConsentBanner(), ThemeProvider(), ThemeProviderProps (+13 more)
...
Cohesion: 0.11
Nodes (19): ChoosePlanPageContent(), DOWNGRADE_REASONS, DowngradeReason, formatPeriodEndDate(), getLostFeatures(), mapPlanToFeatureKey(), PLAN_FEATURE_DISPLAY, PlanChangeDialog() (+11 more)
...
Cohesion: 0.08
Nodes (30): SubscriptionContext, SubscriptionContextValue, SubscriptionData, SubscriptionProvider(), SubscriptionProviderProps, useSubscription(), FavoriteButton(), FavoriteButtonProps (+22 more)
...
Cohesion: 0.10
Nodes (19): JobAIChat(), JobAIChatProps, Message, MessageInput(), MessageInputProps, DEGREE_OPTIONS, DEGREE_REGIONS, DegreeCombobox() (+11 more)
...
## Knowledge Gaps
- **795 isolated node(s):** `FieldType`, `SemanticType`, `QuestionOption`, `ApplicationQuestion`, `ExtractionResult` (+790 more)
...
- **Why does `cn()` connect `Job Card UI & Utils` to `Dashboard Page & UI Primitives`, `NPM Dependencies`, `Setup Wizard Form Steps`, `Landing Page UI`, `Account & Subscription Pages`, `Public Pages & Footer`, `Chat Panel Components`, `Layout & Theme Toggle`, `Setup Wizard & Filter Validation`, `Dialog Components`, `Layout Provider & Cookie Consent`, `Pricing & Plan Selection`, `Toast Hook`, `Community 104`, `Community 107`, `Community 109`, `Community 110`, `Community 115`, `Community 121`?**
...
- **Why does `clsx` connect `NPM Dependencies` to `Job Card UI & Utils`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **What connects `FieldType`, `SemanticType`, `QuestionOption` to the rest of the system?**
