...
## Summary
- 2105 nodes · 4301 edges · 128 communities (117 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e362860`
...
Cohesion: 0.05
Nodes (64): formatPreferencesForAI(), getUserLearnedPreferences(), AIFeature, canUseAI(), CanUseAIResult, CanUseFeatureResult, checkCanUseFeature(), checkNearLimits() (+56 more)
...
Cohesion: 0.07
Nodes (40): AIUsage, UsageDetails(), UsageIndicator(), UsageIndicatorProps, FavoriteButtonProps, sizeConfig, getScoreTheme(), PreferenceMatch() (+32 more)
...
Cohesion: 0.14
Nodes (20): POST(), GET(), DELETE(), favoriteSchema, GET(), POST(), canAccessFeature(), GET() (+12 more)

### Community 8 - "Setup Wizard Form Steps"
Cohesion: 0.09
Nodes (26): DEGREE_OPTIONS, DEGREE_REGIONS, DegreeCombobox(), EducationEntry, EducationSectionProps, EMPTY_ENTRY, SKILL_PRESETS, SkillsSectionProps (+18 more)
...
Cohesion: 0.12
Nodes (16): ANNOUNCEMENTS_RATE_LIMIT, GET(), VALID_PLANS, GET(), formatPlanName(), getRequiredPlan(), applicationAnswersSchema, isValidJobStatus() (+8 more)
...
Cohesion: 0.06
Nodes (35): AdminAuditLogWithAdmin, AIUsageStats, AIUsageWithLimits, ApplicationAnswer, ATSSource, AutoApplyMode, AutoApplyQuota, AutoApplyStatus (+27 more)
...
Cohesion: 0.08
Nodes (27): getJobInteractionHistory(), getUserInteractionStats(), lastComputeTime, shouldTriggerRecompute(), trackInteractionAndLearn(), trackInteractionsBatch(), GET(), safeCompare() (+19 more)

### Community 17 - "Supabase Server Client"
Cohesion: 0.16
Nodes (13): buildSearchQueries(), curateJobsForUser(), CurationResult, fetchPersonalizedJobs(), getInternalCallUserId(), POST(), Feature, FEATURE_INFO (+5 more)
...
Cohesion: 0.15
Nodes (22): injectDiversity(), mergeExplicitWithLearnedPreferences(), getQueriesForAPI(), getCompanySizeCategory(), mapIndustriesToTaxonomyFilter(), mapWorkArrangementsToFilter(), computeProfileHash(), getCachedQueries() (+14 more)
...
Cohesion: 0.08
Nodes (32): MessageInput(), MessageInputProps, UpgradeModalEventDetail, COUNTRY_PHONE_CODES, CVGeneratorDialog(), CVGeneratorDialogProps, EducationEntry, getPhoneCodeFromCountry() (+24 more)

### Community 32 - "Job Matching Route"
Cohesion: 0.28
Nodes (8): generateApplicationQuestions(), CONTENT_TYPES, CV_DIR, DELETE(), errorResponse(), GET(), isValidUUID(), POST()
...
Cohesion: 0.10
Nodes (23): ReportStats, Tester, TesterInvite, TesterInviteStatus, TesterStats, User, UserReport, AdminAnnouncement (+15 more)
...
Cohesion: 0.16
Nodes (36): checkAdminAuth(), announcementTypeSchema, createAnnouncementSchema, DELETE(), deleteAnnouncementSchema, GET(), PATCH(), POST() (+28 more)
...
Cohesion: 0.07
Nodes (31): JobAIChat(), JobAIChatProps, Message, ChoosePlanPageContent(), UpgradeModal(), useSubscription(), AdminPage(), SkillsSection() (+23 more)
...
Cohesion: 0.24
Nodes (9): ThemeToggle(), useTheme(), DashboardLayout(), SystemMessage, clearChatState(), clearToastState(), Avatar, AvatarFallback (+1 more)
...
Cohesion: 0.25
Nodes (7): FilterValidationError, FilterValidationResult, getMissingScreeningFields(), isMandatoryScreeningFieldValid(), validateScreeningAnswers(), ValidationError, ValidationResult
...
Cohesion: 0.47
Nodes (5): getUserPreferences(), GET(), GET_RATE_LIMIT_CONFIG, POST(), RATE_LIMIT_CONFIG

## Knowledge Gaps
- **796 isolated node(s):** `AtsPlatform`, `FieldType`, `SemanticType`, `QuestionOption`, `ApplicationQuestion` (+791 more)
...
- **Why does `cn()` connect `Job Card UI & Utils` to `Dashboard Page & UI Primitives`, `NPM Dependencies`, `Setup Wizard Form Steps`, `Landing Page UI`, `Account & Subscription Pages`, `Public Pages & Footer`, `Chat Panel Components`, `Layout & Theme Toggle`, `Setup Wizard & Filter Validation`, `Dialog Components`, `Job Preferences Step`, `Pricing & Plan Selection`, `Toast Hook`, `Community 104`, `Community 107`, `Community 109`, `Community 110`, `Community 114`, `Community 115`, `Community 121`?**
...
- **Why does `clsx` connect `NPM Dependencies` to `Job Card UI & Utils`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **What connects `AtsPlatform`, `FieldType`, `SemanticType` to the rest of the system?**
