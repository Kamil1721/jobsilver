...
## Corpus Check
- 342 files · ~292,598 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2148 nodes · 4382 edges · 127 communities (115 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c9122c9`
...
Cohesion: 0.05
Nodes (38): INDUSTRY_CATEGORIES, JOB_TITLES_BY_INDUSTRY, DEFAULT_JOB_FILTERS, DEFAULT_SCREENING_ANSWERS, SetupWizard(), STEPS, WizardData, StepCV() (+30 more)
...
Cohesion: 0.06
Nodes (50): DOWNGRADE_REASONS, formatPeriodEndDate(), getLostFeatures(), mapPlanToFeatureKey(), PLAN_FEATURE_DISPLAY, PlanChangeDialog(), PlanChangeDialogProps, PlanFeatureKey (+42 more)

### Community 4 - "Community 4"
Cohesion: 0.13
Nodes (23): ChatHeaderProps, ApplicationQuestion, Action, ActionType, actionTypes, addMessage(), ChatState, clearChatState() (+15 more)
...
Cohesion: 0.13
Nodes (21): POST(), GET(), DELETE(), favoriteSchema, GET(), POST(), canAccessFeature(), GET() (+13 more)

### Community 8 - "Setup Wizard Form Steps"
Cohesion: 0.14
Nodes (20): AdminAuthResult, getAdminEmails(), getRedactedAdminEmails(), isAdminEmail(), adminUserDeleteSchema, adminUsersQuerySchema, adminUserUpdateSchema, apiUsageActionSchema (+12 more)
...
Cohesion: 0.15
Nodes (15): getJobInteractionHistory(), getUserInteractionStats(), lastComputeTime, shouldTriggerRecompute(), trackInteractionAndLearn(), trackInteractionsBatch(), BATCH_RATE_LIMIT, batchInteractionSchema (+7 more)

### Community 12 - "Account & Subscription Pages"
Cohesion: 0.10
Nodes (24): AnswerValue, CvUploadState, INITIAL_CV, NormalizedQuestion, QuestionsResponse, QuestionType, StatusResponse, TERMINAL_STATUSES (+16 more)
...
Cohesion: 0.15
Nodes (16): ThemeToggle(), UpgradeModal(), useTheme(), DashboardLayout(), SystemMessage, Avatar, AvatarFallback, AvatarImage (+8 more)
...
Cohesion: 0.23
Nodes (8): GET(), FEATURE_INFO, FEATURE_REQUIREMENTS, formatPlanName(), getRequiredPlan(), PLAN_HIERARCHY, SUBSCRIPTION_PLAN_HIERARCHY, GET()
...
Cohesion: 0.12
Nodes (16): checkRateLimitDistributed(), checkRateLimitInMemory(), InternalAuthOptions, InternalAuthResult, RateLimitConfig, RateLimitRecord, RateLimitResult, rateLimitStore (+8 more)
...
Cohesion: 0.09
Nodes (24): ANNOUNCEMENTS_RATE_LIMIT, VALID_PLANS, GET(), safeCompare(), buildSearchQueries(), curateJobsForUser(), CurationResult, fetchPersonalizedJobs() (+16 more)
...
Cohesion: 0.07
Nodes (39): AIUsage, UsageDetails(), UsageIndicator(), UsageIndicatorProps, JobCardProps, JobCardSkeleton(), ColumnStatus, containerVariants (+31 more)

### Community 29 - "Search Route & Query Prep"
Cohesion: 0.15
Nodes (19): injectDiversity(), mergeExplicitWithLearnedPreferences(), GeneratedQueries, QueryGenerationInput, getCompanySizeCategory(), mapIndustriesToTaxonomyFilter(), mapWorkArrangementsToFilter(), computeProfileHash() (+11 more)
...
Cohesion: 0.09
Nodes (27): MessageInput(), MessageInputProps, UpgradeModalEventDetail, COUNTRY_PHONE_CODES, CVGeneratorDialog(), CVGeneratorDialogProps, EducationEntry, getPhoneCodeFromCountry() (+19 more)
...
Cohesion: 0.08
Nodes (28): JobAIChat(), JobAIChatProps, Message, useSubscription(), AdminPage(), FavoriteButton(), FavoriteButtonProps, sizeConfig (+20 more)
...
Cohesion: 0.13
Nodes (41): GET(), checkAdminAuth(), announcementTypeSchema, createAnnouncementSchema, DELETE(), deleteAnnouncementSchema, GET(), PATCH() (+33 more)
...
Cohesion: 0.25
Nodes (7): SubscriptionContext, SubscriptionContextValue, SubscriptionData, SubscriptionProvider(), SubscriptionProviderProps, PlanLimits, AllSubscriptionPlans
...
Cohesion: 0.25
Nodes (9): ChatButton(), ChatHeader(), ChatPanel(), ChatPanelProps, getPageContext(), PAGE_CONTEXT_HINTS, ChatProvider(), toggleChat() (+1 more)
...
Cohesion: 0.19
Nodes (14): DELETE(), AuditEventType, auditLog(), AuditLogEntry, AuditSeverity, generateRequestId(), getClientIp(), logAccountEvent() (+6 more)
...
Cohesion: 0.36
Nodes (6): Feature, FeatureAccessResult, useFeatureAccess(), FeatureGateProps, LockedBadge(), LockedBadgeProps
...
Cohesion: 0.10
Nodes (19): DEGREE_OPTIONS, DEGREE_REGIONS, DegreeCombobox(), EducationEntry, EducationSectionProps, EMPTY_ENTRY, SKILL_PRESETS, SkillsSection() (+11 more)

### Community 114 - "Community 114"
Cohesion: 0.10
Nodes (26): AggregatedPreferences, aggregatePreferences(), computeConfidence(), computeUserPreferences(), CONFIDENCE_THRESHOLDS, ExtractedFeatures, extractJobFeatures(), extractKeywords() (+18 more)
...
Cohesion: 0.05
Nodes (65): formatPreferencesForAI(), getUserLearnedPreferences(), AIFeature, canUseAI(), CanUseAIResult, CanUseFeatureResult, checkCanUseFeature(), checkNearLimits() (+57 more)

### Community 120 - "Community 120"
Cohesion: 0.40
Nodes (4): QuickAction, QuickActions(), QuickActionsProps, JobContextPayload
...
## Knowledge Gaps
- **802 isolated node(s):** `PhoneFieldProps`, `answersBodySchema`, `DbQuestionRow`, `AshbyFieldEntry`, `AshbyFormSection` (+797 more)
...
- **Why does `cn()` connect `Setup Wizard & Filter Validation` to `Plans & AI Usage Tracking`, `Dashboard Page & UI Primitives`, `Community 4`, `NPM Dependencies`, `Landing Page UI`, `Account & Subscription Pages`, `Public Pages & Footer`, `Chat Panel Components`, `Dialog Components`, `Community 35`, `Preference Scoring`, `Pricing & Plan Selection`, `CV Text Extraction`, `Community 104`, `Community 107`, `Community 110`, `Community 111`, `Community 113`, `Community 117`, `Community 120`?**
...
- **What connects `PhoneFieldProps`, `answersBodySchema`, `DbQuestionRow` to the rest of the system?**
