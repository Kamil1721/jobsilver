...
## Corpus Check
- 329 files · ~288,471 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2097 nodes · 4294 edges · 126 communities (114 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65f80ef5`
...
Cohesion: 0.06
Nodes (60): formatPreferencesForAI(), AIFeature, canUseAI(), CanUseAIResult, CanUseFeatureResult, checkCanUseFeature(), checkNearLimits(), DailyUsageStats (+52 more)
...
Cohesion: 0.06
Nodes (41): AIUsage, UsageDetails(), UsageIndicator(), UsageIndicatorProps, JobCard(), JobCardProps, JobCardSkeleton(), ColumnStatus (+33 more)

### Community 3 - "Dashboard Page & UI Primitives"
Cohesion: 0.09
Nodes (33): DOWNGRADE_REASONS, formatPeriodEndDate(), getLostFeatures(), mapPlanToFeatureKey(), PLAN_FEATURE_DISPLAY, PlanChangeDialog(), PlanChangeDialogProps, PlanFeatureKey (+25 more)
...
Cohesion: 0.09
Nodes (41): authenticateCronRequest(), curateJobsForUser(), CurationSummary, fetchAndCurateJobs(), fetchJobsFromSearch(), GET(), POST(), safeCompare() (+33 more)

### Community 7 - "Rate Limiting & Feature Access"
Cohesion: 0.12
Nodes (42): ANNOUNCEMENTS_RATE_LIMIT, GET(), VALID_PLANS, GET(), GET(), POST(), DELETE(), favoriteSchema (+34 more)

### Community 8 - "Setup Wizard Form Steps"
Cohesion: 0.09
Nodes (26): DEGREE_OPTIONS, DEGREE_REGIONS, DegreeCombobox(), EducationEntry, EducationSectionProps, EMPTY_ENTRY, SKILL_PRESETS, SkillsSection() (+18 more)
...
Cohesion: 0.07
Nodes (40): ReportStats, Tester, TesterInvite, TesterInviteStatus, TesterStats, User, UserReport, AnswerValue (+32 more)

### Community 13 - "Announcements & Notifications"
Cohesion: 0.05
Nodes (38): AdminAnnouncement, AdminAuditLog, AdminAuditLogWithAdmin, AIUsageStats, AIUsageWithLimits, ApplicationAnswer, ATSSource, AutoApplyMode (+30 more)

### Community 14 - "Public Pages & Footer"
Cohesion: 0.14
Nodes (8): PublicFooter(), PublicFooterProps, metadata, useTheme(), FAQ_CATEGORIES, FAQItem(), metadata, metadata

### Community 15 - "Audit Logging & Admin Routes"
Cohesion: 0.12
Nodes (29): checkoutRequestSchema, getBaseUrl(), POST(), DowngradeReason, getStripeErrorMessage(), POST(), VALID_REASONS, isDowngrade() (+21 more)

### Community 16 - "Interaction Tracking"
Cohesion: 0.07
Nodes (31): getJobInteractionHistory(), getUserInteractionStats(), lastComputeTime, shouldTriggerRecompute(), trackInteractionAndLearn(), trackInteractionsBatch(), applyTesterInvite(), GET() (+23 more)

### Community 17 - "Supabase Server Client"
Cohesion: 0.19
Nodes (11): GET(), Feature, FEATURE_INFO, FEATURE_REQUIREMENTS, formatPlanName(), getRequiredPlan(), PLAN_HIERARCHY, SUBSCRIPTION_PLAN_HIERARCHY (+3 more)
...
Cohesion: 0.09
Nodes (28): AggregatedPreferences, aggregatePreferences(), computeConfidence(), computeUserPreferences(), CONFIDENCE_THRESHOLDS, ExtractedFeatures, extractJobFeatures(), extractKeywords() (+20 more)
...
Cohesion: 0.11
Nodes (17): DEFAULT_JOB_FILTERS, DEFAULT_SCREENING_ANSWERS, SetupWizard(), STEPS, WizardData, StepCV(), StepCVProps, StepFinal() (+9 more)

### Community 29 - "Search Route & Query Prep"
Cohesion: 0.17
Nodes (17): GeneratedQueries, QueryGenerationInput, getCompanySizeCategory(), mapIndustriesToTaxonomyFilter(), mapWorkArrangementsToFilter(), computeProfileHash(), getCachedQueries(), setCachedQueries() (+9 more)

### Community 30 - "Multi-Source ATS Search"
Cohesion: 0.16
Nodes (21): searchAshbyJobs(), getAshbyBoards(), getGreenhouseBoards(), getLeverCompanies(), searchGreenhouseJobs(), searchATSJobs(), createJobFingerprint(), JobSourceConfig (+13 more)

### Community 31 - "Dialog Components"
Cohesion: 0.13
Nodes (20): UpgradeModal(), UpgradeModalEventDetail, COUNTRY_PHONE_CODES, CVGeneratorDialog(), CVGeneratorDialogProps, EducationEntry, getPhoneCodeFromCountry(), WorkHistoryEntry (+12 more)
...
Cohesion: 0.22
Nodes (6): fraunces, inter, metadata, ConsentStatus, CookieConsent, CookieConsentBanner()
...
Cohesion: 0.19
Nodes (9): DowngradeReason, PRICING_PLANS, PricingCard(), PricingCardProps, PricingFeature, PricingPlan, BillingCycle, PricingToggle() (+1 more)
...
Cohesion: 0.09
Nodes (25): ChoosePlanPageContent(), useSubscription(), AdminPage(), FavoriteButton(), FavoriteButtonProps, sizeConfig, Action, ActionType (+17 more)
...
Cohesion: 0.12
Nodes (35): checkAdminAuth(), announcementTypeSchema, createAnnouncementSchema, DELETE(), deleteAnnouncementSchema, PATCH(), POST(), updateAnnouncementSchema (+27 more)
...
Cohesion: 0.12
Nodes (15): JobAIChat(), JobAIChatProps, Message, MessageInput(), MessageInputProps, ThemeToggle(), JobNotes(), JobNotesProps (+7 more)
...
Cohesion: 0.27
Nodes (6): DashboardLayout(), SystemMessage, clearChatState(), Avatar, AvatarFallback, AvatarImage
...
## Knowledge Gaps
- **789 isolated node(s):** `$schema`, `crons`, `maxDuration`, `maxDuration`, `maxDuration` (+784 more)
...
- **Why does `cn()` connect `Job Card UI & Utils` to `Dashboard Page & UI Primitives`, `NPM Dependencies`, `Setup Wizard Form Steps`, `Landing Page UI`, `Subscription Context & Feature Gate`, `Account & Subscription Pages`, `Public Pages & Footer`, `Chat Panel Components`, `Layout & Theme Toggle`, `Setup Wizard & Filter Validation`, `Dialog Components`, `Pricing & Plan Selection`, `Toast Hook`, `Toast UI Components`, `Community 104`, `Community 107`, `Community 109`, `Community 110`, `Community 114`, `Community 115`, `Community 121`?**
